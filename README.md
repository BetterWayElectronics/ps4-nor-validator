...
## Version History: ##
	1.8.9 (N/A) Added CoreOS Swapping + Southbridge Flag Patching, Added Improved CoreOS Intepretation/Validation, Added UserIDs, Improved File Handling including the /Dumps/ Subdirectory Traversal, Improved Validation of PerConsole Areas.
